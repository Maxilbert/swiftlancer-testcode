// TODO - Pedersen Commitment, Elgamal Encryption, Decryption, Measure the Gas
...
library BigNumber {
    ...
    /** @dev _new: "View" version of Creating a new Bignumber instance.
    ...
    /** @dev "Pure" Version of Creating a new Bignumber instance.
      *
      * parameter: bytes val - bignum value
      * parameter: bool  neg - sign of value
      * parameter: uint bitlen - bit length of value
   ...
   function bn_sub(bytes max, bytes min) private pure returns (bytes memory, uint) {
    ...
    /** @dev cmp: instance comparison. 'signed' parameter indicates whether to consider the sign of the inputs.
